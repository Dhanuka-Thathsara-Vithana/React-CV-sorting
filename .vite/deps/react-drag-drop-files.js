...
var ie = [":", "[", ".", "#"];
function ae(e3) {
  var t2, n3, r3, o2, s3 = void 0 === e3 ? w : e3, i3 = s3.options, a3 = void 0 === i3 ? w : i3, c3 = s3.plugins, u3 = void 0 === c3 ? S : c3, l3 = new stylis_browser_esm_default(a3), d3 = [], p2 = function(e4) {
    function t3(t4) {
      if (t4)
        try {
          e4(t4 + "}");
...
function Ye(e3, t2, n3) {
  ...
  } }), Pe(p2, v3), A.warnTooManyClasses = function(e4, t3) {
    var n4 = {}, r3 = false;
    return function(o3) {
